...
exports.XdebugProfileReadonlyEditorProvider = exports.XDEBUG_PROFILE_VIEW_TYPE = void 0;
...
<head>
	...
	<title>${(0, templateHelpers_1.escapeHtmlAttr)(ui.title)}</title>
	<style nonce="${nonce}">
		:root {
	...
	<div class="layout">
		<section class="panel">
			<div class="header">
				<div class="head-row">
					<div class="title">
						<span class="icon">${(0, templateHelpers_1.iconGraph)()}</span>
						<span>${(0, templateHelpers_1.escapeHtmlAttr)(ui.title)}</span>
					</div>
					<div class="head-actions">
						<span class="badge" id="badgeEvent">Event</span>
						<button id="toggleDetailsBtn" class="btn" type="button">${(0, templateHelpers_1.escapeHtmlAttr)(ui.hideDetails)}</button>
					</div>
				</div>
			...
			<div class="toolbar">
				<div class="search">
					<span class="icon">${(0, templateHelpers_1.iconSearch)()}</span>
					<input id="filterInput" class="input" type="text" placeholder="${(0, templateHelpers_1.escapeHtmlAttr)(ui.searchPlaceholder)}" />
				</div>
			</div>
				...
				<table>
					<thead>
						<tr>
							...
							<th data-sort="memSelf">${(0, templateHelpers_1.sortableHeader)(ui.memSelf, ui.tipMemSelf)}</th>
							<th data-sort="timeTotal">${(0, templateHelpers_1.sortableHeader)(ui.timeTotal, ui.tipTimeTotal)}</th>
							<th data-sort="calls">${(0, templateHelpers_1.sortableHeader)(ui.calls, ui.tipCalls)}</th>
							<th data-sort="cpuAvg">${(0, templateHelpers_1.sortableHeader)(ui.cpuAvg, ui.tipCpuAvg)}</th>
							<th data-sort="memAvg">${(0, templateHelpers_1.sortableHeader)(ui.memAvg, ui.tipMemAvg)}</th>
							<th data-sort="timeAvg">${(0, templateHelpers_1.sortableHeader)(ui.timeAvg, ui.tipTimeAvg)}</th>
							<th data-sort="pctSelf">${(0, templateHelpers_1.sortableHeader)(ui.pctSelf, ui.tipPctSelf)}</th>
						</tr>
					</thead>
		...
		<section class="panel" id="detailsPanel">
			<div class="header">
				<div class="head-row">
					<div class="title">
						<span class="icon">${(0, templateHelpers_1.iconFunction)()}</span>
						<span id="selectedTitle">${(0, templateHelpers_1.escapeHtmlAttr)(ui.selectFunction)}</span>
					</div>
					<button id="openSourceBtn" class="btn" disabled>
						<span class="icon">${(0, templateHelpers_1.iconOpen)()}</span>
						${(0, templateHelpers_1.escapeHtmlAttr)(ui.openSource)}
					</button>
				</div>
				<div class="meta" id="selectedLocation">${(0, templateHelpers_1.escapeHtmlAttr)(ui.source)}: ${(0, templateHelpers_1.escapeHtmlAttr)(ui.unknown)}</div>
			</div>
			<div class="side-content">
				<div class="side-block">
					<div class="section-title">${(0, templateHelpers_1.escapeHtmlAttr)(ui.metrics)}</div>
					<div class="metric-groups" id="selectedMetrics"></div>
				</div>
				<div class="side-block">
					<div class="section-title">${(0, templateHelpers_1.escapeHtmlAttr)(ui.structure)}</div>
					<div class="metric-grid" id="selectedStructure"></div>
				</div>
				<div class="side-block">
					<div class="section-title"><span class="info-wrap"><span>${(0, templateHelpers_1.escapeHtmlAttr)(ui.callers)}</span><span class="info-dot" data-tip="${(0, templateHelpers_1.escapeHtmlAttr)(ui.tipCallersSection)}">i</span></span></div>
					<div class="list" id="callersList"></div>
				</div>
				<div class="side-block">
					<div class="section-title"><span class="info-wrap"><span>${(0, templateHelpers_1.escapeHtmlAttr)(ui.callees)}</span><span class="info-dot" data-tip="${(0, templateHelpers_1.escapeHtmlAttr)(ui.tipCalleesSection)}">i</span></span></div>
