import { CachegrindEdge, CachegrindFunction, CachegrindProfile } from '../cachegrind/parser';
...
export class RiskEngine {
	private readonly graphCacheByProfile = new WeakMap<CachegrindProfile, GraphCache>();

	public computeBreakageRisk(profile: CachegrindProfile, fn: CachegrindFunction): BreakageRiskResult {
...
function pickTimeEvent(events: string[], primaryEvent: string): string | undefined {
